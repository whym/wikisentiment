...
if __name__ == '__main__':
    ...
    for fx in [SentiWordNetExtractor('SentiWordNet_3.0.0_20100908.txt'), NgramExtractor(2), NgramExtractor(2, lowercase=True), WikiPatternExtractor()]:
        ...
        print fx.extract({"entry" : { "content" : {'added': ["DO NOT POST THE FINAL AIRING OF WBHS AGAIN...WBHS WILL STAY ON AS LONG AS I AM A STUDENT AT BHS!!!! You are a sick human being to post \"I support Insurgency\" on your page...21:22, 8 February 2007 (UTC)Kgregory21:22, 8 February 2007 (UTC)"], 'removed':[]}, "receiver" : "Trillionaire", "sender" : "Kgregory", "rev_id" : 10192272, "title" : "Trillionaire", 'comment': [] } })
